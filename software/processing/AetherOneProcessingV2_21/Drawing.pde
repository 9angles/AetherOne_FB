...
void draw() {
  ...
  drawBlueLED("CLEARING", x + 65, y, 20, arduinoConnection.clearing);
  drawGreenLED("ANALYSING", x + 130, y, 23, false);
  drawBlueLED("SIMULATION", x + 195, y, 26, !arduinoConnection.arduinoFound);
  drawGreenLED("COPY", x + 260, y, 10, arduinoConnection.copy);
  drawBlueLED("GROUNDING", x + 316, y, 25, arduinoConnection.grounding);
  
  drawGreenLED("BROADCASTING", x, y + 68, 20, arduinoConnection.broadcasting);
  drawRedLED("HOTBITS", x, y + 136, 20, arduinoConnection.collectingHotbits);
